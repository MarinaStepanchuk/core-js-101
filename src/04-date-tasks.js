...
function timeSpanToString(startDate, endDate) {
  ...
  let milliSeconds;
  if ((endDate.getMilliseconds() - startDate.getMilliseconds()) > 99) {
    milliSeconds = `${endDate.getMilliseconds() - startDate.getMilliseconds()}`;
  } else if ((endDate.getMilliseconds() - startDate.getMilliseconds()) > 9) {
    milliSeconds = `0${endDate.getMilliseconds() - startDate.getMilliseconds()}`;
  } else {
...
function angleBetweenClockHands(date) {
  ...
  const angleDeg = Math.abs(angleHours - angleMinutes);
  if (angleDeg > 180) {
